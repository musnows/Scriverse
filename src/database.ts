  ...
  private migrate(): void {
    this.raw.exec(`
      ...
      CREATE TABLE IF NOT EXISTS providers (
        ...
        monthly_token_quota INTEGER CHECK(monthly_token_quota IS NULL OR monthly_token_quota >= 10000),
