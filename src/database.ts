    ...
    if (!applied.has(73)) {
      this.transaction(() => {
        ...
        this.run(`CREATE TABLE IF NOT EXISTS platform_backup_settings (
          ...
          retention_count INTEGER NOT NULL DEFAULT 7 CHECK(retention_count >= 1 AND retention_count <= 365),
        ...
        this.run("CREATE INDEX IF NOT EXISTS idx_platform_backup_targets_order ON platform_backup_targets(sort_order, created_at)");
