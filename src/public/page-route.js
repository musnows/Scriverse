...
export function serializePageRoute(route = {}) {
  ...
  if (view === "login") {
    ...
    params.set("work", workId);
  } else if (view === "settings" || view === "platform-ai" || view === "platform-usage" || view === "platform-backup" || (view === "work-audit" && workId)) {
...
export function parsePageRoute(hash = "") {
  ...
  if (view === "settings" || view === "platform-ai" || view === "platform-usage" || view === "platform-backup" || (view === "work-audit" && workId)) {
