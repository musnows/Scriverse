...
expect(page.text).toContain('/app.js?v=20260812-s3-backup-v1');
    ...
    expect(page.text).toContain('id="s3-backup-include-images"');
    expect(page.text).toContain('id="s3-backup-schedule-time"');
    expect(page.text).toContain('id="s3-backup-retention"');
    expect(application.text).toContain('api("/api/platform/s3-backup"');
    expect(application.text).toContain('api("/api/platform/s3-backup/run"');
    expect(styles.text).toContain(".s3-backup-schedule-grid");
