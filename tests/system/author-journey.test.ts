...
describe("作者完整创作流程", () => {
  ...
  it("首屏书架、大纲伏笔、续写守卫和关系银河图资源完整可达", async () => {
    ...
    expect(page.text).toContain('id="platform-backup-view"');
    expect(page.text).toContain('id="platform-backup-target-dialog"');
    expect(application.text).toContain('showPlatformBackup');
    expect(application.text).toContain('/api/platform/backup/run');
