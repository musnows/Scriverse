...
describe("作者完整创作流程", () => {
  ...
  it("首屏书架、大纲伏笔、续写守卫和关系银河图资源完整可达", async () => {
    ...
    expect(application.text).toContain('/page-route.js?v=20260812-ai-write-approvals-v1');
    expect(page.text).toContain('data-module="ai-approvals"');
    expect(page.text).toContain("AI 操作审批");
    expect(application.text).toContain("AI 操作审批中心");
    expect(application.text).toContain("AI 可写工具");
    expect(application.text).toContain("查看完整修改详情");
    expect(application.text).toContain("（最推荐）");
    expect(application.text).toContain("审计记录");
