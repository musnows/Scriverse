...
expect(page.text).toContain('/app.js?v=20260805-platform-backup-v1');
    ...
    expect(page.text).toContain('id="platform-backup-return"');
    ...
    expect(styles.text).toContain(':is(#users-dialog, #platform-ui-settings-dialog, #platform-backup-dialog, #members-dialog, #appearance-dialog) select:not([multiple]) {');
    ...
    expect(page.text).toContain('id="platform-backup-button" class="settings-hub-card hidden"');
    expect(page.text).toContain('id="platform-ui-settings-dialog"');
    expect(page.text).toContain('id="platform-backup-dialog"');
    expect(page.text).toContain('id="platform-backup-run"');
    expect(application.text).toContain('api("/api/platform/backup/settings"');
    expect(application.text).toContain('api("/api/platform/backup/run"');
    expect(application.text).toContain("notifyBackupFailureIfNeeded");
