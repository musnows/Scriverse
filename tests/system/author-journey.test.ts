...
describe("作者完整创作流程", () => {
  ...
  it("首屏书架、大纲伏笔、续写守卫和关系银河图资源完整可达", async () => {
    ...
    expect(page.text).toContain('/styles.css?v=20260724-setting-preview-clamp');
    ...
    expect(application.text).toContain('class="record-card character-card has-card-edit" data-open-character');
