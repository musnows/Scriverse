...
describe("角色抽取结果入库预览界面", () => {
  it("在任务详情中加载、勾选、编辑并确认角色候选", async () => {
    ...
    expect(page).toContain('/styles.css?v=20260812-ai-conversation-export-mobile-foreshadow-epub-character-extraction-v1');
    expect(page).toContain('/app.js?v=20260812-ai-stream-connectivity-global-replace-foreshadow-epub-character-extraction-v1');
