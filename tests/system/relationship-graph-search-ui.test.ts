...
describe("人物关系图搜索界面", () => {
  ...
  it("在普通图、放大图和银河图提供可访问的人物搜索与定位入口", async () => {
    ...
    expect(page.text).toContain('/app.js?v=20260809-galaxy-frame-rate-v2');
    expect(application.text).toContain('/relationship-graph.js?v=20260809-galaxy-frame-rate-v2');
