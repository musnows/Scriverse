...
describe("知识模块布局切换", () => {
  ...
  it("设定、角色、种族、组织、伏笔与审核保留卡片并支持列表切换", async () => {
    ...
    expect(page.text).toContain('<script type="module" src="/app.js?v=20260812-ai-stream-connectivity-global-replace-foreshadow-epub-character-extraction-outline-v1"></script>');
