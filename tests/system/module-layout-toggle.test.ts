...
describe("知识模块布局切换", () => {
  ...
  it("设定、角色、种族、组织、伏笔与审核保留卡片并支持列表切换", async () => {
    ...
    expect(page.text).toContain('<script type="module" src="/app.js?v=20260803-multimodal-model-test-v3"></script>');
    ...
    expect(application.text).toContain('/display-labels.js?v=20260801-google-vertex');
